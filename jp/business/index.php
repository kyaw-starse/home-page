                        ...
                        <div class="consignBox cFix">
                            ...
                            <div class="c-boxRight">
                                <div class="consign-txt consign-txt01">
                                    <p>
                                    スクラッチ開発におけるサイト運用までの下記の流れの中で、最も重要なのが「要件定義」です。<br>「要件定義」→「設計」→「プログラム開発」→「テスト」→「運用」<br>弊社は、スクラッチ開発の要件定義を進めるにあたり、お客様が「システムで何を実現したいか？」システム要件を明らかにするところからスタートします。<br>
                ...
                <div data-aos="fade-up">
                    ...
                    <div class="dx-sec01 letter">
                        <div class="cFix">
                            ...
                            今、世の中を取り巻く環境はデジタル化により大きく、且つ急激に変化してきています。<br>それに伴いお客様のニーズも様々に変化しています。その中で当社がクローズアップしたいのは、DXを実現するIT技術者の不足です。
                            </p>
                            <p class="letter-lead-txt">
                            ...
                            <ul class="list">
                                <li>
                                    <p class="pri-num"><span class="font-normal">1.</span>お客様ニーズを的確に捉え、その要求に適合したDXソリューションを開発、ご提供いたします。</p>
                                </li>
                                <li>
                                    <p class="pri-num"><span class="font-normal">2.</span>社内の技術者並びに、経営層、営業に対し最新のデジタル化技術を学習、取得する為の教育支援を行います。</p>
                                </li>
                                <li>
                                    <p class="pri-num"><span class="font-normal">3.</span>社内環境についてはリモート開発の推進、Web会議、AWS上での開発など、可能な限りデジタル開発環境を整備し、DX支援企業としてモデル企業を目指します。</p>
                                </li>
                                <li>
                                    <p class="pri-num"><span class="font-normal">4.</span>DX企業として、自社ソリューションをDX環境下で構築し、学習内容を実現することで社員の能力向上を目指します（絆プロジェクト）</p>
                                </li>
                                <li>
                                    <p class="pri-num"><span class="font-normal">5.</span>社内DX化を積極的に推進する為、社内に推進部を設け社内デジタル化の旗振り、並びに推進化の数値化を行い経営に反映致します。</p>
                                </li>
                            </ul>
                    ...
                    <div class="dx-sec02" data-aos="fade-up">
                        ...
                        <div class="textBox">
                            <h2 class="boxTxt pri-num"><span>1.</span>DX方針を実現するために「DX推進部」を設置する ここでの任務は</h2>
                            <div class="boxDesp">
                                <p>
                                DX先端技術の調査、研究並びに、自社への導入検討<br>
                                導入を決定したDX技術の教育カリキュラムの作成、既存社員並びに、中途採用者への教育実施<br>
                        ...
                        <div class="textBox">
                            ...
                            <div class="boxDesp">
                                <p>
                                STAR SEのDXソリューションである「技術者情報提供サービス“絆”」の開発、保守運用<br>
