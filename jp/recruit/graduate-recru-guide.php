                ...
                <div class="h-right cFix">
                    ...
                    <div class="h-utility">
                        <ul class="cFix">
                            ...
                            <li class="site-lang">
                                <a href="/home-page/en/recruit/graduate-recru-guide.php" class="lang-link">EN</a>
                                <a href="/home-page/jp/recruit/graduate-recru-guide.php" class="lang-link langOn">JP</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section class="sec-graduate04 bg-green-light">
            <div class="c-w1170">
                <div>
                    ...
                    <div class="sec-btn02">
                        <a href="/home-page/jp/form/entry-newGraduate.php" class="btn02">エントリー</a>
                    </div>
                </div>
            </div>
        </section>
