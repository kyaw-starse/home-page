    ...
    <div id="wrapper" class="top-wrap">
                ...
                <div class="h-right cFix">
                    ...
                    <div class="h-utility">
                        <ul class="cFix">
                            ...
                            <li class="site-lang">
                                <a href="/home-page/en/form/entry-infraEngineer.php" class="lang-link">EN</a>
                                <a href="/home-page/jp/form/entry-infraEngineer.php" class="lang-link langOn">JP</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <canvas class="particlesBg"></canvas>
            <div class="sub-bannerIn c-w1170">
                <h2 class="sub-ttl">インフラエンジニアフォーム</h2>
            </div>
        </div>
        <!-- sub-banner -->
        <div class="content">
            ...
            <div class="c-w1170">
                <div class="form-block letter">
                    <form action="entry/entry-infraEngineer.php"  method="post" class="php-email-form" id="entry-infra-engineer-form" enctype="multipart/form-data">
                        ...
                        <div class="form-row form-mb">
                            <div class="form-col1">
                                <label for="keyiyakuflg" class="form-label">希望の契約形態<span class="require">*</span></label>
