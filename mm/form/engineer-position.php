...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 // メールアドレス
  ...
  //   if ($responseData->success) {
      ...
      $contact->subject = "[STAR SE MYANMAR Co., Ltd.] Engineer Position Application";
  ...
  ";
      ...
      $contact2->subject = "Engineer Position Application" . "【" . $name . "】";
      ...
      The following is the content of the Engineer Position Application.
      *This email is ";
