...
<body id="top" class="top">
    ...
    <div id="wrapper" class="top-wrap">
        ...
        <section class="security-page">
            <div class="c-w1170">
                <h2 class="ttl-subpage"><span class="text-un-yellow">Information Security</span></h2>
                <div class="security-head letter">
                    <div class="security-content">
                        <a href="private-security.php" class="security-head-link">
                            <h2 class="security-head-ttl">Personal Information Security</h2>
                            <span class="security-head-line"></span>
                            <p class="security-head-txt">STAR SE Co., Ltd. recognizes the importance of protecting personal information as a company that provides IT services as the foundation of society, formulates a mechanism for personal information management to properly protect personal information, and as follows We will establish 「Personal Information Protection Policy」 and strive to protect.</p>
                            <p class="security-head-linkTxt">Read More</p>
                          </a>
                    </div>
                    <div class="security-content">
                        <a href="security-info.php" class="security-head-link">
                            <h2 class="security-head-ttl">Information Security Policy</h2>
                            <span class="security-head-line"></span>
