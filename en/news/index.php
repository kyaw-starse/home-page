                    ...
                    <ul>
                        ...
                        <li data-aos="fade-up" data-aos-delay="110">
                            <a href="/home-page/en/news/news-detail.php" class="newsLink">
                                ...
                                <p class="newsTtl">DX strategy was formulated.</p>
                            </a>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                                ...
                                <p class="newsTtl">ISO/IEC 27001:2013 Certification was acquired.</p>
                            </a>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                                <span class="newsDate">2019/12/23</span>
                                <p class="newsTtl">Capital Increased to 45 million yen</p>
                            </a>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                        ...
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                                ...
                                <p class="newsTtl">We held STAR SE Co., Ltd. 2019 Happy New Year and Welcome Party for New Employees.</p>
                            </a>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                        ...
                        <li data-aos="fade-up" data-aos-delay="130">
                            <a href="javascript:void(0)" class="newsLink">
                                <span class="newsDate">2018/10/27</span>
                                <p class="newsTtl">We went to Kusatsu Onsen as company trip.</p>
                            </a>
                        </li>
                    </ul>
                </div>
