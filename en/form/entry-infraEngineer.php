...
<head>
    ...
    <title>Infra Engineer Form</title>
    ...
    <div id="wrapper" class="top-wrap">
                ...
                <div class="h-right cFix">
                    ...
                    <div class="h-utility">
                        <ul class="cFix">
                            ...
                            <li class="site-lang">
                                <a href="/home-page/en/form/entry-infraEngineer.php" class="lang-link langOn">EN</a>
                                <a href="/home-page/jp/form/entry-infraEngineer.php" class="lang-link">JP</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <canvas class="particlesBg"></canvas>
            <div class="sub-bannerIn c-w1170">
                <h2 class="sub-ttl">Infra Engineer Form</h2>
            </div>
        </div>
        <!-- sub-banner -->
        <div class="content">
