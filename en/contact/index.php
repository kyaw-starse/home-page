        ...
        <header class="headerBlock">
            <div class="header c-w1420">
                ...
                <div class="h-right cFix">
                    ...
                    <div class="h-utility">
                        <ul class="cFix">
                            <li class="h-icon"><a href="/home-page/en/contact/" class="mail-icon navpc-active"><img src="/home-page/assets/img/common/mail_off.png" alt=""></a></li>
                            <li class="h-icon"><a href="/home-page/en/login/" class="lock-icon"><img src="/home-page/assets/img/common/lock_off.png" alt=""></a></li>
                            <li class="site-lang">
                                <a href="/home-page/en/contact/" class="lang-link langOn">EN</a>
                                <a href="/home-page/jp/contact/" class="lang-link">JP</a>
                            </li>
                        </ul>
                    </div>
                </div>
